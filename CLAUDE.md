...
- Feature-based folder structure (e.g. DAG, Dashboard, Run, shared)
- Each feature is organized into layers:
  - **feature layer** — smart containers, stateful components with business logic
  - **business logic layer** — hooks and functions handling business logic
  - **domain layer** — types, API-FE integration, transformers, converters, API calls
  - **ui layer** — dumb components, presentational layer
...
- write tailwind classes only in ui layer
