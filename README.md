...
- For SSO-only staging servers, set `DEV_PROXY_COOKIE` locally so the Vite proxy can forward an existing browser session cookie while the browser stays on localhost
