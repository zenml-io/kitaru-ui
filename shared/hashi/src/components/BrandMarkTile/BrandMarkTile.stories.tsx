...
const meta: Meta<typeof BrandMarkTile> = {
	...
	parameters: {
		design: {
			type: "figma",
			url: "https://www.figma.com/design/IZhfgAOIPjDObsCtpFKhRY/Hashi-Design-System?node-id=244-11",
		},
	},
	args: {
		brand: "zenml",
...
// Both brand variants side by side — same square tile; the `data-app-mark`
// attribute only pins the brand color tokens.
export const Variants: Story = {
	render: () => (
		<div className="flex flex-wrap items-end gap-8">
			<div className="flex flex-col items-center gap-2">
				<BrandMarkTile brand="zenml" />
				<span className="text-muted-foreground text-xs">zenml</span>
			</div>
			<div className="flex flex-col items-center gap-2">
				<BrandMarkTile brand="kitaru" />
				<span className="text-muted-foreground text-xs">kitaru</span>
			</div>
		</div>
	),
};
