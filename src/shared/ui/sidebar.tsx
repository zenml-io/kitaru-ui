...
import { useIsMobile } from "@/shared/business-logic/use-mobile";
	...
	return (
		<SidebarContext.Provider value={contextValue}>
			<div
				...
				className={cn(
					"group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar relative flex min-h-svh w-full overflow-hidden",
					className
				)}
				{...props}
			>
